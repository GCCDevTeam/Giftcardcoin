...
int64 nChainStartTime = 1427176200;
...
const string strMessageMagic = "GiftNet Signed Message:\n";
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in GiftNet
    bool fStrictPayToScriptHash = true; // Always active in GiftNet
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "GiftNet", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Like a phoenix rises from the ashes, Giftcard Coin is reborn.";
        CTransaction txNew;
        ...
        assert(block.hashMerkleRoot == uint256("0x18e86412e8a1f187c93bfd7fe915a0106dba5ba74372e66fb6d5f7481e3c9b52"));
